...
const PopularBook = (): React.ReactNode => {
  return (
    <div className="popular-book d-flex justify-content-between  align-items-center flex-column gap-1 ">
      <figure className="popular-book overflow-hidden position-relative rounded-2">
        ...
        <div className="layer text-white pb-4 ps-3">
          <div className="position-absolute bottom-0">
            ...
            <p className="inter small-font opacity-75">by james Clear</p>
          </div>
        </div>
      </figure>
      <h5 className="playfair h6 m-0">Atomic Habits</h5>
      <p className="normal-font opacity-75 m-0">James Clear</p>
